...
func TestInsert(t *testing.T) {
  ...
  tree.Insert("foreach")
  tree.Insert("face")
  tree.Insert("facetime")
  tree.Insert("facebook")
  tree.Insert("facebook groups")
  tree.Insert("facebook group")
}

func TestRemoveNotExisted(t *testing.T) {

}

func TestRemoveExistedButNotALeaf(t *testing.T) {

}

func TestRemoveExistedWithNoChildren(t *testing.T) {

}

func TestRemoveExistedWithOneChildren(t *testing.T)  {

}

func TestRemoveExistedWithMultipleChildren(t *testing.T)  {
